...
<section class="w-4/12 h-3/6 flex py-3 justify-around my-6 items-center flex-col rounded-lg bg-n-dark-grayish-blue shadow-lg drop-shadow max-xs:w-screen max-xs:mx-4 max-xs:h-3/6 max-sm:w-screen max-sm:mx-4 max-sm:h-3/6 max-md:w-5/12 max-lg:w-5/12">
  {#await adviceObject}
  ...
  <p class="px-3  text-clip text-center text-md text-primary-light-cyan  ">
  ...
  <picture>
    ...
    <img src={DeskDiv} alt="desktop divider icon" class="w-11/12 flex justify-center items-center mx-auto">
  </picture>
